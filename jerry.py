    ...
    if not_joined:
        if is_group:
            ...
            await update.effective_message.reply_text(
                f"🐭 <b>Oopsie {update.effective_user.first_name}!</b> 🐭\n\n"
                f"Jerry can't help you in groups unless you join our channels first! 😤\n\n"
                f"Join: {channel_list}\n"
                f"Then DM me @{(await context.bot.get_me()).username} to start! 💕",
                parse_mode='HTML'
            )
        else:
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_group_chat(update):
        await update.message.reply_text(
            "🐭 <b>Hewwo group! Jerry here!</b> 🎉\n\n"
            "I can search for info right here in the group! 😎\n"
            "But first, everyone needs to:\n\n"
            "1️⃣ Join my channels (check with any command)\n"
            "2️⃣ DM me once to get credits\n"
            "3️⃣ Then search here freely! 🚀\n\n"
            "<i>🐭 Jerry loves group chats! Let's have fun! 💕</i>",
            parse_mode='HTML'
        )
        return
            ...
            try:
                await context.bot.send_message(
                    ...
                    text=f"🎉 <b>Yay! New friend!</b> 🎉\n\n"
                         ...
                         f"<i>Keep sharing! Jerry's proud of you! 🥰</i>",
                    parse_mode='HTML'
                )
            except:
                pass
    ...
    savage_messages = [
        "Took you long enough! 😤 Jerry was getting bored! 💅",
        "Oh look who decided to show up! 🙄 Jerry's been waiting! ⏰",
        "Finally! Jerry thought you got lost! 😂",
        "Yay! Another human to boss around! 😈💕",
        "Welcome! Jerry's gonna spoil you with info! 🐭✨"
    ]
...
<b>I'm Jerry, your cute but savage info finder! 😎</b>

━━━━━━━━━━━━━━━━━━━━━━━━
🎀 <b>What I Can Find (No Cap!):</b>

📱 Phone Numbers - Stalk mode activated! 🔍
🆔 Aadhaar Details - Family secrets? 👀
🚗 Vehicle Info - Is your car clean? 🚨
🌐 IP Addresses - I see you! 👁️
🏦 IFSC Codes - Bank details go brrr 💰
📮 PIN Codes - Post office vibes ✉️
📸 Instagram - Time to creep! 😏
🤖 AI Chat - I'm smart AND sassy! 🧠

━━━━━━━━━━━━━━━━━━━━━━━━
🎁 <b>SPECIAL OFFER:</b> 5 FREE searches!
💝 <b>Refer Friends:</b> Get {REFERRAL_REWARD} credits per friend!
👥 <b>Use in Groups:</b> Jerry works in GCs too! 

━━━━━━━━━━━━━━━━━━━━━━━━
💌 <b>Made with sass by Jerry!</b> 🐭💕
<i>Now go search something! Don't be shy! 🙈</i>
"""
...
<b>Bruh, it's not rocket science! 🙄</b>

━━━━━━━━━━━━━━━━━━━━━━━━
🔍 <b>SEARCH COMMANDS:</b>

📱 /num <code>phone</code> - Stalk someone! 👀
🆔 /aadhaar <code>aadhaar</code> - Family drama incoming! 👨‍👩‍👧
🚗 /vehicle <code>reg_no</code> - Check if they got tickets! 😂
🌐 /ip <code>ip_address</code> - GPS go brrr! 🛰️
🏦 /ifsc <code>ifsc_code</code> - Bank info for days! 💰
📮 /pincode <code>pin</code> - Post office vibes! 📬
📸 /insta <code>username</code> - Creep mode: ON! 😏
🤖 /ask <code>question</code> - Jerry's big brain time! 🧠

━━━━━━━━━━━━━━━━━━━━━━━━
💼 <b>YOUR STUFF:</b>

💎 /credits - How broke are you? 💸
🎫 /redeem <code>CODE</code> - Free stuff? Yes please! 🎁
💝 /referral - Make your friends pay! 😈
💰 /withdraw - Cash out! Cha-ching! 🤑

━━━━━━━━━━━━━━━━━━━━━━━━
💵 <b>PRICING (Oof):</b>
5💎=₹20 | 15💎=₹50 | 40💎=₹100 | 100💎=₹200

🎁 <b>REFERRAL:</b> {REFERRAL_REWARD} credit per victim... I mean friend! 😅

━━━━━━━━━━━━━━━━━━━━━━━━
👥 <b>GROUP CHAT POWER!</b>
...
━━━━━━━━━━━━━━━━━━━━━━━━
🐭 <b>Jerry: Cute but savage since 2025!</b> 💕
<i>Now stop reading and go search something! 😤</i>
"""
...
async def ask_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(context.args) == 0:
        await update.message.reply_text(
            "🤖 <b>Ask Jerry anything!</b>\n\n"
            "But like... actually ask something! 🙄\n\n"
            "<b>Usage:</b> /ask <code>your question</code>\n\n"
            "<b>Examples:</b>\n"
            "• /ask What is love?\n"
            "• /ask Why is the sky blue?\n"
            "• /ask How to get rich?\n\n"
            "<i>🐭 Jerry's waiting! Don't be boring! 😤</i>",
            parse_mode='HTML'
        )
        return
    ...
    thinking_msgs = [
        "🐭 Jerry's thinking... This better be good! 💭",
        "🧠 Activating Jerry's big brain... 💭",
        "🤔 Hmm, interesting question... 💭",
        "💭 Jerry's processing... Give me a sec! 🐭",
        "🔮 Jerry's consulting the magic 8-ball... 💭"
    ]
    import random
    ...
    outros = [
        "Hope that helped, bestie! 💕",
        "Jerry's so smart, right? 😏",
        "You're welcome! Jerry rocks! 🎸",
...
async def num_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not user:
        await update.message.reply_text(
            ...
            "Jerry can't work with amateurs! 😤\n\n"
    ...
    if len(context.args) == 0:
        savage_msgs = [
            "Dude, where's the number? 🙄",
            "Hello? Number please! 😑",
            "Jerry needs a number, not telepathy! 🔮",
            "Did you forget the number? Happens! 😂"
        ]
        import random
        await update.message.reply_text(
            f"❌ <b>{random.choice(savage_msgs)}</b>\n\n"
            "<b>Usage:</b> /num <code>phone_number</code>\n"
            "<b>Example:</b> /num 9876543210\n\n"
            "<i>🐭 Jerry's waiting! Type it right this time! 💅</i>",
            parse_mode='HTML'
        )
        return
    ...
    if user[2] <= 0:
        await update.message.reply_text(
            "🚨 <b>BROKE ALERT!</b> 🚨\n\n"
            "Bestie, you're out of credits! 💸\n"
            "Jerry doesn't work for free! 😤\n\n"
            "Buy more or refer friends! 💰\n\n"
            "<i>🐭 Jerry needs to eat too, you know! 🍕</i>",
            parse_mode='HTML'
        )
        return
    ...
    process_msgs = [
        "🔍 Jerry's hacking the mainframe... JK! 🐭",
        "🔍 Stalking mode activated... 👀",
        "🔍 Jerry's doing some cyber magic... ✨",
        "🔍 Searching... This better be good! 😏",
        "🔍 Jerry's on it! No pressure! 😎"
    ]
    import random
    ...
    if "error" in data or not data.get('data'):
        fail_msgs = [
            "😢 Bruh, Jerry found nothing!\nThat number's a ghost! 👻",
            "😢 No luck, bestie!\nEither fake number or Jerry's too good for this! 💅",
            "😢 Jerry tried SO hard!\nBut this number said 'nah'! 🙅",
            "😢 Mission failed!\nWe'll get 'em next time! 😤"
        ]
        await processing_msg.edit_text(
            f"{random.choice(fail_msgs)}\n\n"
            f"<i>Remaining: {user[2]} credits (Jerry still charged you lol! 😈)</i>",
            parse_mode='HTML'
        )
        return
    ...
    try:
        ...
        success_intros = [
            "🎯 <b>BOOM! Jerry found it!</b> 🎯",
            "✨ <b>EZ! Jerry never misses!</b> ✨",
            "🔥 <b>Got 'em! Jerry's too good!</b> 🔥",
            "💅 <b>Called it! Jerry wins again!</b> 💅",
            "🎉 <b>Jackpot! Jerry delivers!</b> 🎉"
        ]
...
🐭 <b>Jerry found everything! You're welcome! 😏</b>
"""
        await processing_msg.edit_text(response, parse_mode='HTML')
    except Exception as e:
        await processing_msg.edit_text(
            f"💥 <b>Oops! Jerry broke something!</b>\n\n"
            f"Error: {str(e)}\n\n"
            f"<i>Credits: {user[2]} (Don't blame Jerry! 😅)</i>",
            parse_mode='HTML'
        )
...
async def credits_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user:
        ...
        # Funny credit status messages
        if user[2] == 0:
            status_msg = "💀 <b>BROKE MODE ACTIVATED!</b> 💀\nBestie, you need credits ASAP! 😭"
        elif user[2] < 5:
            status_msg = "⚠️ <b>Low Balance Alert!</b> ⚠️\nJerry's getting worried about you! 😰"
        elif user[2] < 20:
            status_msg = "😊 <b>Decent!</b> You're doing okay! 👍"
        elif user[2] < 50:
            status_msg = "🎉 <b>Nice stash!</b> Jerry's impressed! 💰"
        else:
            status_msg = "💎 <b>RICH VIBES!</b> 💎\nLook at you, fancy pants! 😎"
...
━━━━━━━━━━━━━━━━━━━━━━━━
💵 <b>Buy Credits (Easy money for Jerry!):</b>
  • 5 credits = ₹20 (Starter pack! 🎒)
  • 15 credits = ₹50 (Getting serious! 💪)
  • 40 credits = ₹100 (Big brain move! 🧠)
  • 100 credits = ₹200 (WHALE ALERT! 🐋)

📞 Contact admin to buy!

━━━━━━━━━━━━━━━━━━━━━━━━
🐭 <b>Jerry's keeping track!</b> 💕
<i>Don't go broke now! 😤</i>
"""
        keyboard = [[InlineKeyboardButton("🔙 Back", callback_data="back_to_start")]]
